    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <input id="name" v-model.trim="table.name" type="text" class="form-control" required pattern="{{ $db->identifierRegex }}">
            </div>
        @if($db->action == 'create')
...
@include('shuttle::database.vue-components.database-column')
@include('shuttle::database.vue-components.database-table-helper-buttons')
