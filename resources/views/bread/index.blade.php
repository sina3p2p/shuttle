...
@section('breadcrumbs')
    @include('shuttle::includes.breadcrumbs', ['breadCrumbs' => ['მთავარი' => route('shuttle.index'), 'მოდელები' => route('shuttle.bread.index')]])
@stop
                        ...
                        <tr>
                            ...
                            <td>
                                @if($table->dataTypeId)
                                    ...
                                    <a href="{{ route('shuttle.bread.edit', $table->name) }}" class="btn btn-primary">Edit</a>
                                    <a href="#delete-bread" data-id="{{ $table->dataTypeId }}" data-name="{{ $table->name }}" class="btn btn-danger delete">Delete</a>
                                @else
                                    <a href="{{ route('shuttle.bread.create', $table->name) }}" class="btn btn-secondary">Create Bread</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
