...
@section('main')
    <div class="content-body">
        ...
        <form action="@if(isset($dataType->id)){{ route('shuttle.bread.update', $dataType->id) }}@else{{ route('shuttle.bread.store') }}@endif" method="POST">
...
{{--                                        @endif--}}
    ...
    @include('shuttle::bread.relationship-new-modal')
@stop
