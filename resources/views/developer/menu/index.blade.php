                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" id="menu-name-input" placeholder="Menu Name" value="{{$menu->name}}" @if($menu->name) disabled @endif>
                                        </fieldset>
                                    </div>
                                    <div class="col-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <select class="form-control select2-single" id="basicSelect" name="menuable_id">
                                                                            ...
                                                                            @foreach($m["data"] ?? [] as $d)<option value="{{$d->id}}">{{$d->name}}</option>@endforeach
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-12">
    ...
    <script>
        $(document).ready(function () {
            ...
            function buildItem(item) {
                var nestedItem = {"id": item.id ,"name":(item.menuable ? item.menuable.name : item.title), "info": item, "children":[]};
                if (item.children) {
                    nestedItem["children"] = [];
