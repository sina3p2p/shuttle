...
<tr class="newTableRow">
    ...
    <td>
        <input v-model="column.fillable" type="checkbox">
    </td>
    ...
    <td>
        <a href="#" class="btn-sm btn-danger delete-row" @click.prevent="deleteColumn"><i class="simple-icon-trash"></i></a>
    </td>
...
@include('shuttle::developer.database.vue-components.database-types')
@include('shuttle::developer.database.vue-components.database-column-default')
