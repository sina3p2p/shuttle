    ...
    <div class="sub-menu">
        <div class="scroll">
            <ul class="list-unstyled" data-link="developer">
                <li><a href="{{route('shuttle.database.index')}}"><i class="simple-icon-layers"></i>ბაზები</a></li>
                <li><a href="{{route('shuttle.bread.index')}}"><i class="simple-icon-organization"></i>მოდელები</a></li>
                <li><a href="{{route('shuttle.component.index')}}"><i class="simple-icon-puzzle"></i>კომპონენტები</a></li>
                <li><a href="{{route('shuttle.type.index')}}"><i class="simple-icon-compass"></i>ტიპები</a></li>
            </ul>
        </div>
    </div>
    @endif
