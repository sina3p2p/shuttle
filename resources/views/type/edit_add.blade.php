            ...
            <div class="mb-2">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('shuttle.type.index')}}">ტიპები</a>
                        </li>
                        <li class="breadcrumb-item">
                    ...
                    <div class="col-md-3 col-12">
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <form action="{{ ($add) ? route('shuttle.type.store') : route('shuttle.type.update',$type->id)}}" class="form form-vertical" method="post">
