<template>
  ...
  >
    <div class="ti-input">
      <draggable tag="ul" v-if="tagsCopy" :list="tagsCopy" class="ti-tags">
        ...
        >
          <div class="ti-content">
            ...
            <div ref="tagCenter" class="ti-tag-center">
              ...
              >
                <input :name="`${name}[]`" :value="tag.text" hidden />
                {{ tag.text }}</span
              >
              <shuttle-tag-input
                v-if="!$scopedSlots['tag-center']"
          ...
          <div class="ti-actions">
            ...
            <i
              ...
              class="iconsminds-undo"
              @click="cancelEdit(index)"
            ></i>
            <i
              v-if="!$scopedSlots['tag-actions']"
              v-show="!tagsEditStatus[index]"
              class="iconsminds-close"
        ...
        <li class="ti-new-tag-input-wrapper">
          <input
            ...
            @keydown="performAddTags(newTag, $event)"
...
export default {
  ...
  methods: {
    ...
    focus(index) {
      this.$nextTick(() => {
        const el =
          this.$refs.tagCenter[index].querySelector("input.ti-tag-input");
        if (el) el.focus();
      });
    },
    quote(regex) {
  ...
  created() {
    ...
    else if (this.value && this.value.length) this.tags = this.value;
