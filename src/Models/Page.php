...
class Page extends Model
{
    ...
    {
        return $this->belongsToMany('Sina\Shuttle\Models\Component','page_component')->using('Sina\Shuttle\Models\PageComponent')->withPivot('setting','component_id','locale','id')->orderBy('position');
    }
