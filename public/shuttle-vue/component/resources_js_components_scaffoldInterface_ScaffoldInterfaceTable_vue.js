...
var render = function render() {
  ...
  return _c("div", {
    staticClass: "page page_add"
  }, [_c("div", {
    staticClass: "page-title"
  }, _vm._l(_vm.tableColumn, function (c, index) {
    return _c("div", {
      key: "header-column-" + index,
      staticClass: "page-title__item"
    }, [_vm._v("\n      " + _vm._s(c.title) + "\n    ")]);
  }), 0), _vm._v(" "), _c("div", {
    staticClass: "page-content"
  }, _vm._l(_vm.res.data, function (row, i) {
    return _c("div", {
      key: i,
      staticClass: "page-content__item"
    }, _vm._l(_vm.tableColumn, function (c, index) {
      return _c("div", {
        key: "c-" + i + "-" + index,
        staticClass: "item-init",
        domProps: {
          innerHTML: _vm._s(row[c.data])
        }
      });
    }), 0);
  }), 0)]);
